...
Aplicação usando o framework Java Spring Boot, Postgres e  GIt 
...
```
- *[Projeto](https://github.com/thiagoocms/app-crud)*
...
```
```
3° - Abra o PostgreSQL e crie o banco "test". PS: Lembre de trocar em properties as senhas de conexão do banco para evitar conflitos.
```
```
4° - Procure o arquivo "CrudApplication.java" e inicie o programa no play.
```
...
Nós usamos [GIT](https://git-scm.com/downloads) para controle de versão no [GITHUB](https://github.com/thiagoocms/app-crud). Para as versões disponíveis, observe as [tags neste repositório](https://github.com/thiagoocms/app-crud).  
...
Você também pode ver a lista de todos os [colaboradores](https://github.com/thiagoocms/app-crud/graphs/contributors) que participaram deste projeto. 
